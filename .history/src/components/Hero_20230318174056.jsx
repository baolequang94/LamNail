...
const Hero = () => {
	return (
		<div className="h-screen bg-[url('./assets/nail-2.jpg')] bg-cover">
			{/* <img src={nail2} className="object-cover h-full w-full blur-sm" /> */}
			<div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center backdrop-blur-sm">
