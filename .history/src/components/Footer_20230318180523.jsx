	...
	return (
		<div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-black">
			...
			<div className="lg:col-span-2 flex justify-between mt-6">
				<div>
					<h6 className="font-semibold text-black">Địa chỉ</h6>
					<ul>
				...
				<div>
					<h6 className="font-semibold text-black">Giờ làm việc</h6>
					<ul>
						<li className="py-2 text-sm">Thứ 2 - Thứ 6</li>
						<li className="py-2 text-sm">8:00 - 20:00</li>
						<li className="py-2 text-sm">Thứ 7 - Chủ Nhật</li>
